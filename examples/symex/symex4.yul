    ...
    object "symex4_376_deployed" {
        code {
            ...
            function fun_eurus_prank_once_392(var_addr_384) {
                ...
                /// @src 0:227:253  "revert(\"eurus_prank_once\")"
                {
                    let _5 := allocate_unbounded()
                    mstore(_5, 3963877391197344453575983046348115674221700746820753546331534351508065746944)
                    let _6 := abi_encode_tuple_t_stringliteral_046e3b60602e4c9ae035a6752d3453a5f0b8da88167fb304fd5bb28922e092b0__to_t_string_memory_ptr__fromStack(add(_5, 4) )
                    revert(_5, sub(_6, _5))
                }
            }
            /// @src 1:3602:3962  "contract symex4 is Eurus {..."
        ...
        data ".metadata" hex"a26469706673582212209d18a55641271115d7e66caca2ae205a7c8cb45b52ac16f3bf04915a2591ef8064736f6c634300080e0033"
    }
