...
(provide (prefix-out yul: (all-defined-out)))
...
(struct dobj (name code data) #:mutable #:transparent #:reflection-name 'yul:dobj) ; sub-level dispatcher object
(struct data (res0 res1) #:mutable #:transparent #:reflection-name 'yul:data)
